...
yt-dlp  --playlist-end 1 --write-thumbnail --write-info -f bestvideo[ext=webm]+bestaudio[ext=m4a]  -o '%(id)s.mp4'  --merge-output-format mp4 https://www.youtube.com/watch?v=Xv62yzQ4fM8
